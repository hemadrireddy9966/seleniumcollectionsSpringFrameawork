...
#|automationtesting281@gmail.com  |674592   |Selenium automation testing  |Selenium Sample test glossary|Telugu  |C:\Users\Hemadri Reddy\Videos\chromedownload31aus-10\websitetranslationcsvFiles\test.csv    |
#
#@WsTnsGloData
#Scenario Outline: user should able to import glossary with all words unverified
#Given User fills the Login Page "<emailid>" and "<otp>"
#When user should be able to select "<language>" in "<glossary>" file in "<team>" Team
#And user should be able to import a glossary file with all glossary words should be Un verified
#Then he should be to verify his glossary should be Un verified
#Examples:
...
Examples:
|emailid                         |otp      |team                         |glossary               |language |
|automationtesting281@gmail.com  |674592   |Selenium automation testing  |teamMember TestGlossary|Telugu   |
...
|automationtesting281@gmail.com  |674592   |Selenium automation testing  |teamMember TestGlossary      |Telugu   |Proudly powered by |విత్ర వెబ్సైటు త్రన్స్లతిఒన్ టెస్టింగ్  |Proudly powered by,విత్ర వెబ్సైటు త్రన్స్లతిఒన్ టెస్టింగ్  |
...
|automationtesting281@gmail.com  |674592   |Selenium automation testing  |teamMember TestGlossary      |Telugu  |Proudly powered by|
